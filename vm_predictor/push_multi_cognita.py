...
def push_to_cognita (model, dataframe, feat_cols):
    ...
    template_name = 'crome-multi-classifier-1'    
...
if __name__ == "__main__":
    ...
    tmpfile = "training_multi.csv"
    
    print ("train: ", training_filename)
    cp = CromeProcessor (target, feats=features)
    model = cp.build_model_from_CSV(training_filename, data_out=tmpfile)
    
    # need to provide cognita a copy of the training dataframe
