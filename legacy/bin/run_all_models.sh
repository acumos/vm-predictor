...
python ../../vm_predictor/subscriber_models.py vnf_cpumem_flt_timecols.csv cpu_usage
python ../../vm_predictor/subscriber_models.py vnf_cpumem_flt_timecols.csv mem_usage
